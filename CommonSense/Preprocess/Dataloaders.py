...
class DownstreamDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        ans_d = np.array(self.input_dict["ans_d"][index])
        ans_e = np.array(self.input_dict["ans_e"][index])
        ...
        ans_d_att = np.array(self.input_dict["ans_d_att"][index])
        ans_e_att = np.array(self.input_dict["ans_e_att"][index])
